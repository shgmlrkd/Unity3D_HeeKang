...
public class InGameTime : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        SoundManager.Instance.PlayBGM(SoundKey.NormalBGM, 0.7f);
    ...
    private void Update()
    {
        ...
        if (_timerPhase == TimerPhase.Countdown && _inGameTimer <= 0.0f && _timerCoroutine != null)
        {
            ...
            SoundManager.Instance.PlayFX(SoundKey.BossIntroSound, 0.7f);
        ...
        if (_camShake.IsShakeEnd && !_isInitTimer)
        {
            ...
            SoundManager.Instance.PlayBGM(SoundKey.BossBGM, 0.7f);
